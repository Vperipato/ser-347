# -*- coding: utf-8 -*-
"""
Created on Fri May  8 11:58:29 2020
...
plt.barh(grupos, -feminino, color = 'pink', label="Feminino")
plt.barh(grupos, masculino, color = 'lightblue', label="Masculino")

plt.xlabel("População", fontsize=16)
plt.ylabel("Grupos de idade", fontsize=16)
plt.title("Distribuição da população brasileira (2010)", fontsize=24)
