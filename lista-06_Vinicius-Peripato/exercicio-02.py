# -*- coding: utf-8 -*-
"""
Created on Fri May  8 11:10:22 2020
...
plt.bar(grupos, feminino, color='pink')
plt.xlabel("Grupos de idade", fontsize=16)
plt.ylabel("População", fontsize=16)
plt.title("Distribuição da população feminina (2010)", fontsize=24)
ax = plt.gca()
